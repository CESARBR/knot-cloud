...
Stacks for development and production are provided in order to assist the user needs. Regardless of running in production or development, check the [Local deployment considerations](README.md#Local_deployment__considerations) if it applies to your scenario.
If you are running in production mode, go ahead to [configure and deploy your stack](README.md#Stage_1).
